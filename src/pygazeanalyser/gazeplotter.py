...
def parse_fixations(fixations):
	...
	# get all fixation coordinates, very inefficent but maintaining as much of original as possible.. 
	for fixnr in range(len( fixations)):
		fix['x'][fixnr] = fixations.iloc[fixnr,0]
		fix['y'][fixnr] = fixations.iloc[fixnr,1]
		fix['dur'][fixnr] = fixations.iloc[fixnr,2]
